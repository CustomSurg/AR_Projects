...
IL_007d_1:
			...
			}
			{
				...
				L_27 = MixedRealityPlayspace_TransformPoint_mD203A2BAA284D29EE790B62E04D4A1C0501930AB(L_26, NULL);
				V_13 = L_27;
				// rotation = MixedRealityPlayspace.Rotation * rotation;
				Quaternion_tDA59F214EF07D7700B26E40E562F267AF7306974 L_28;
				L_28 = MixedRealityPlayspace_get_Rotation_m793D29AB1F279A65BE47A03F7D6AA890CB7B695E(NULL);
...
IL_0129_1:
			{
				...
				L_49 = Quaternion_op_Multiply_mCB375FCCC12A2EC8F9EB824A1BFB4453B58C2012_inline(G_B14_1, G_B14_0, NULL);
...
IL_00c3_1:
			{
				...
				il2cpp_codegen_runtime_class_init_inline(CoreServices_tCB1FB80E338B89BCA07C52C15B876BC6D4B3439B_il2cpp_TypeInfo_var);
				RuntimeObject* L_32;
				L_32 = CoreServices_get_InputSystem_m09CC5207090321051B3C092D5BA21F2858DCD607(NULL);
		...
		{// begin try (depth: 1)
			{
				...
				L_3 = MixedRealityInteractionMapping_get_AxisType_mCD3EA297AACF47BE8DFCCDCEBB0ABD2F5933EA40_inline(L_2, NULL);
				il2cpp_codegen_runtime_class_init_inline(Debug_t8394C7EEAECA3689C2C9B9DE9C7166D73596276F_il2cpp_TypeInfo_var);
				Debug_Assert_m6E778CACD0F440E2DEA9ACDD9330A22DAF16E96D((bool)((((int32_t)L_3) == ((int32_t)4))? 1 : 0), NULL);
				// switch (interactionMapping.InputType)
				MixedRealityInteractionMapping_t10DB776EEA5255542F8F4AF0DC0BC566AF0095E0* L_4 = ___interactionMapping0;
				NullCheck(L_4);
				int32_t L_5;
...
IL_004b:
	...
	}
	{
		...
		il2cpp_codegen_runtime_class_init_inline(WindowsMixedRealityUtilities_t07AFD353BEDE3858623D8082A5463B6CB434F8BF_il2cpp_TypeInfo_var);
		WindowsMixedRealityUtilities_set_UtilitiesProvider_m71E62395E87C5A5FEFDE87F9D861CEE5F271DF12_inline(L_8, NULL);
	}
...
IL_0077:
	{
		...
		L_12 = WindowsMixedRealityUtilities_get_SpatialInteractionManager_m128841B3FCF97FD87A2D64E24930CFA5208B661F(NULL);
		V_4 = L_12;
		...
		WindowsRuntimeMarshal_AddEventHandler_TisTypedEventHandler_2_tDBCF13D8CC254870E369ECD1AAA8E0628F36AD8F_m63CB2C497E69436F6D1DC24FF701E1013914AFAE(L_15, L_18, L_19, WindowsRuntimeMarshal_AddEventHandler_TisTypedEventHandler_2_tDBCF13D8CC254870E369ECD1AAA8E0628F36AD8F_m63CB2C497E69436F6D1DC24FF701E1013914AFAE_RuntimeMethod_var);
		// base.Enable();
...
IL_0034:
	...
	}
	{
		...
		L_7 = WindowsMixedRealityUtilities_get_SpatialCoordinateSystem_mCC844EE115A8C3420C3DD54AF97850F78461CCA3(NULL);
		...
		L_8 = DateTimeOffset_get_Now_mFBC17A86139F6EE7C5EBF397BBE5914DCD7B3428(NULL);
		PerceptionTimestamp_tB6F4FC74F93B7123E6E3D53564F7D4E086F62FA9* L_9;
		L_9 = PerceptionTimestampHelper_FromHistoricalTargetTime_m558F5A4BC12C07FC7AA9FA88961B2498C41E0945(L_8, NULL);
		SpatialPointerPose_tF3BA704730C2804061ACAC7324B1C1E9BB98CB34* L_10;
		L_10 = SpatialPointerPose_TryGetAtTimestamp_mA1D43ACA31E94BBDA65E50C79425EC2CB38822FD(L_7, L_9, NULL);
		V_2 = L_10;
		// if (pointerPose != null)
	...
	}
	{
		...
		L_20 = SystemNumericsExtensions_ToUnityVector3_mBBDF1382455F9D34DBEBC4ABEF3724E1293F7254(L_19, NULL);
		...
		L_23 = SystemNumericsExtensions_ToUnityVector3_mBBDF1382455F9D34DBEBC4ABEF3724E1293F7254(L_22, NULL);
		NullCheck(L_17);
...
IL_00d1:
	{
		...
		MixedRealityInputAction_tD3B6E9CE7F20EFC9D066C519FAB848679FC62486 L_37;
		L_37 = MixedRealityInputAction_get_None_mB26E4E6EAC1C69627DA36EF86EDDF8D449075F56_inline(NULL);
...
IL_002a:
	{
		...
		bool L_6;
		L_6 = SpatialInteractionManager_IsSourceKindSupported_mF00B2E8E5E0A523716A57F8ECDCBD800E4D9F6F9(1, NULL);
		V_3 = L_6;
		goto IL_0071;
	}
...
IL_0033:
	{
		...
		bool L_7;
		L_7 = SpatialInteractionManager_IsSourceKindSupported_mF00B2E8E5E0A523716A57F8ECDCBD800E4D9F6F9(3, NULL);
		V_3 = L_7;
		goto IL_0071;
	}
...
IL_003f:
	{
		...
		L_8 = XRSubsystemHelpers_get_DisplaySubsystem_m99E6FA426269724B865C2813A91B58E9718AE5AB(NULL);
		if (!L_8)
		{
			goto IL_0056;
		}
	}
	{
		...
		L_9 = XRSubsystemHelpers_get_DisplaySubsystem_m99E6FA426269724B865C2813A91B58E9718AE5AB(NULL);
		NullCheck(L_9);
		bool L_10;
...
IL_0076_1:
		{
			...
			V_4 = L_15;
			bool L_16;
			L_16 = Nullable_1_get_HasValue_m6B76D139692C43B2AF7C695FAB044B16ACFAF355_inline((&V_4), Nullable_1_get_HasValue_m6B76D139692C43B2AF7C695FAB044B16ACFAF355_RuntimeMethod_var);
			if (!L_16)
			{
				goto IL_00a9_1;
			}
		...
		{
			WindowsMixedRealityEyeGazeDataProvider_t952228E03A9F90397159A21100576CE51C62A6AC* L_17 = __this->___U3CU3E4__this_2;
			NullCheck(L_17);
			Nullable_1_t78F453FADB4A9F50F267A4E349019C34410D1A01 L_18;
			L_18 = WindowsMixedRealityEyeGazeDataProvider_get_IsActiveLoader_m4590049B4C39F81CD6B2476AE42A906E6A02A418(L_17, NULL);
			V_4 = L_18;
			bool L_19;
			L_19 = Nullable_1_get_Value_mE2C54C6AE9FC9F05BF44CD9D7D61DC6CD56E3E28((&V_4), Nullable_1_get_Value_mE2C54C6AE9FC9F05BF44CD9D7D61DC6CD56E3E28_RuntimeMethod_var);
...
IL_00aa_1:
		...
		{
			// Enable();
			WindowsMixedRealityEyeGazeDataProvider_t952228E03A9F90397159A21100576CE51C62A6AC* L_21 = __this->___U3CU3E4__this_2;
			NullCheck(L_21);
		...
		{// begin try (depth: 1)
			{
				...
				L_13 = MixedRealityPlayspace_InverseTransformPoint_mE8D375349BFEDA140BDE99CBA3BA962553B3776D(L_12, NULL);
				V_3 = L_13;
...
IL_007a_1:
			{
				...
				L_17 = XRSubsystemHelpers_get_MeshSubsystem_m6B489CCE2255AF5A814EAB0E4A4A09A8E908237C(NULL);
...
IL_008e_1:
			{
				...
				String_t* L_24;
				L_24 = String_Format_mA8DBB4C2516B9723C5A41E6CB1E2FAF4BBE96DD8(_stringLiteralD97DB8E8CA849A2783B8DA9F426364AEBA3DC48C, L_23, NULL);
				il2cpp_codegen_runtime_class_init_inline(Debug_t8394C7EEAECA3689C2C9B9DE9C7166D73596276F_il2cpp_TypeInfo_var);
